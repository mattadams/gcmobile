...
public class TouchListView extends ListView
{
    ...
    public TouchListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.GroupInform, 0, 0);

            mItemHeightNormal = a.getDimensionPixelSize(R.styleable.GroupInform_normal_height, 0);
            mItemHeightExpanded = a.getDimensionPixelSize(R.styleable.GroupInform_expanded_height, mItemHeightNormal);
            grabberId = a.getResourceId(R.styleable.GroupInform_grabber, -1);
            dragndropBackgroundColor = a.getColor(R.styleable.GroupInform_dragndrop_background, 0x00000000);
            mRemoveMode = a.getInt(R.styleable.GroupInform_remove_mode, -1);
