        ...
        if (mInstances.size() > 1) {
            ...
            ((Button) pager.findViewById(R.id.next)).setOnClickListener(
                    new Button.OnClickListener() {
                        ...
                        public void onClick(View arg0) {
                            setResult(RESULT_OK, (new Intent()).setAction(FormEntryActivity.KEY_NEXT_INSTANCE));
                            finish();
                        }                        
                    });
            ...
            ((Button) pager.findViewById(R.id.previous)).setOnClickListener(
                    new Button.OnClickListener() {
                        @Override
                        public void onClick(View arg0) {
                            setResult(RESULT_OK, (new Intent()).setAction(FormEntryActivity.KEY_PREVIOUS_INSTANCE));
                            finish();
                        }                        
                    });
        ...
        switch (keyCode) {
            case KeyEvent.KEYCODE_BACK:
                ...
                if (mLoadedAutomatically) {
                    setResult(RESULT_OK, (new Intent()).setAction(FormEntryActivity.KEY_FINISH_ACTIVITY));
                    finish();
                }
                // END custom
        }
