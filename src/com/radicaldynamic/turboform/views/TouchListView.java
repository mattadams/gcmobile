...
public class TouchListView extends ListView
{
    ...
    public TouchListView(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.TurboForm, 0, 0);

            mItemHeightNormal = a.getDimensionPixelSize(R.styleable.TurboForm_normal_height, 0);
            mItemHeightExpanded = a.getDimensionPixelSize(R.styleable.TurboForm_expanded_height, mItemHeightNormal);
            grabberId = a.getResourceId(R.styleable.TurboForm_grabber, -1);
            dragndropBackgroundColor = a.getColor(R.styleable.TurboForm_dragndrop_background, 0x00000000);
            mRemoveMode = a.getInt(R.styleable.TurboForm_remove_mode, -1);
